...
public:
    Student(const std::string& studentName) : name(studentName), marks() {}
    
    Student(const std::string& studentName, const std::vector<double>& studentMarks) : name(studentName), marks(studentMarks) {}
